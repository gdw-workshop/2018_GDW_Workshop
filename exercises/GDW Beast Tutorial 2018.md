...
Click on the *Traits* tab (even though we arenÕt using it today:)).  
...
Now letÕs open the MCC tree and check it out.  This is the moment weÕve been working towards.  Exciting I know.
